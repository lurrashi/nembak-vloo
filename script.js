...
yesBtn.addEventListener('click', () => {
    title.innerHTML = "HORE!! sekarang kamu resmii jadi pacarkuuu sayanggggg";
...
noBtn.addEventListener('click', () => {
    if (noCount < 3) {
        ...
        title.innerHTML = "WLEEEE, pencet yess makanyaa";
